...
for i=1:IterationTimes
    x_0
    MVSLRUDTPPDC.time(i)=i*Tspan;
    MVSLRUDTPPDC.X(:,i)=x_0;
     % model of cranes
    MVSLRUDTPPDC.u(i) = towercraneux_CalUq(x_0,K1,U1,domain,n1,q);
    [t,x]=ode45(@SPG_plantnoise,[0,Tspan],x_0,opt,MVSLRUDTPPDC.u(i),lpvux,dt);
    q=q+(y_r-x_0(1))*Tspan;
    x_0=x(end,:)';
end
